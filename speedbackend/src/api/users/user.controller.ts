...
export class UserController {
      ...
      throw new HttpException(
        {
          ...
          error: 'Registration failed please enter correct Information',
        },
  ...
  @Put('/:id')
  async updateUser(@Param('id') id: string, @Body() createuser: CreateUserDto) {
    try {
  ...
  async updateRoleByUsername(
    ...
    try {
      const updatedUser = await this.userservice.updateRoleByUsername(
        username,
